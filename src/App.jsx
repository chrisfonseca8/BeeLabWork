...
>>>>>>> 07a83ef3003253ed5fba91634576245fceadf0a4
...
const styles = `
  ...
  *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
  ...
  .hero-eyebrow {
    ...
    color: #7edfa8; font-size: .8rem; font-weight: 800; text-transform: uppercase;
  ...
  .hero-title {
    ...
    font-weight: 800; color: #ffffff; line-height: 1.1; margin-bottom: 1.5rem;
    text-shadow: 0 2px 16px rgba(0,0,0,.4);
  }
  .hero-title em {
    font-style: normal; color: #7edfa8;
  ...
  .hero-sub {
    ...
    line-height: 1.8; max-width: 560px; margin-bottom: 2.5rem; font-weight: 400;
  }
  .hero-sub strong { color: #7edfa8; font-weight: 700; }
  ...
  .hero-chip {
    ...
    color: rgba(255,255,255,.90); font-size: .8rem; padding: .4rem .9rem;
    border-radius: 50px; font-weight: 600; backdrop-filter: blur(4px);
  }
  .hero-btns { display: flex; gap: 1rem; flex-wrap: wrap; }
  .btn-em {
    background: #18a352; color: #fff; border: none; padding: .85rem 2rem; border-radius: 8px;
  ...
  .btn-ghost {
    ...
    text-transform: uppercase; letter-spacing: .1em; cursor: pointer; text-decoration: none;
    display: inline-block; transition: all .22s; backdrop-filter: blur(4px);
  }
  ...
  .hero-aside {
    background: rgba(5,22,12,.55); border: 1px solid rgba(255,255,255,.14);
  ...
  .hc-val { font-size: .84rem; color: rgba(255,255,255,.82); line-height: 1.45; white-space: pre-line; font-weight: 400; }
...
=======
  ...
  /* ── ABOUT ── */
  /* ★ FIX 2 — align-items:start + reduced gap so long text never clips */
...
>>>>>>> 07a83ef3003253ed5fba91634576245fceadf0a4
  ...
  .day-date { font-weight: 400; color: var(--slate); letter-spacing: .04em; }
  ...
  .ft-brand { font-family: 'Playfair Display', serif; font-size: 1.15rem; font-weight: 700; color: #fff; margin-bottom: .35rem; }
  ...
  .ft-h     { font-size: .72rem; font-weight: 700; text-transform: uppercase; letter-spacing: .14em; color: #7edfa8; margin-bottom: .9rem; }
  ...
  .ft-list li strong { color: #fff; font-weight: 500; }
  ...
  .ft-badge { display: inline-flex; align-items: center; gap: 6px; background: rgba(24,163,82,.12); border: 1px solid rgba(24,163,82,.28); color: #7edfa8; font-size: .68rem; font-weight: 700; text-transform: uppercase; letter-spacing: .12em; padding: .3rem .75rem; border-radius: 50px; }
...
=======
  { name: "Dr. Kalyan Chatterjee",    role: "Professor, Electrical Engineering",           inst: "IIT (ISM) Dhanbad",                           topic: "Emerging Control, AI & Cybersecurity for Sustainable Energy", badge: "Keynote",       image: imgKalyanChatterjee,  bio: "Prof. Chatterjee (Member, IEEE) has over 27 years of research experience in power systems, renewable energy systems, soft computing applications, small-signal stability analysis, and cyber–physical systems. He has guided 19 Ph.D. scholars (6 ongoing) and 40+ postgraduate students, with numerous publications in high-impact journals and conferences." },
  { name: "Dr. Rajesh Gupta",         role: "Professor, Electrical Engineering",           inst: "MNNIT Allahabad, Prayagraj",                   topic: "Digital Controllers in Power Converters for Renewable Energy", badge: "Invited",        image: imgRajeshGupta,       bio: "Dr. Gupta received his M.Tech in Control Systems from BIT Mesra and Ph.D. from IIT Kanpur in Power Electronics. He has guided 14 Ph.D. and 65 Masters students, published 200 papers, holds 4 patents, and was PI for projects from DST, SERB, CSIR, MNRE. Listed among Stanford's top 2% scientists globally (2020–2024)." },
  { name: "Dr. Ritesh Kumar Keshri",  role: "Associate Professor, Electrical Engineering", inst: "VNIT Nagpur",                                  topic: "EV Charging and Grid Interactions",                           badge: "Invited",        image: imgRiteshKeshri,      bio: "Dr. Keshri received his Ph.D. in Energy Engineering from University of Padova, Italy (2014). Previously faculty at BIT Mesra (2006–2015). Recipient of the 2016 Best Paper Award of IEEE Transactions on Industrial Electronics and the Visvesvaraya Young Faculty Research Fellowship (2017). Associate Editor of IEEE OJIES, IEEE TEC, and IEEE JESTIE." },
  { name: "Dr. Sumant G. Kadwane",    role: "Professor, Electrical Engineering",           inst: "Yeshwantrao Chavan College of Engineering.",   topic: "Z-Source Inverter Bidirectional EV Charger for V2G Applications", badge: "Invited",   image: imgSumantKadwane,     bio: "Dr. Kadwane completed his Ph.D. from BIT Mesra (2010) and served as faculty there for 7 years. He has guided 25+ PG students and 6 Ph.D. scholars, published 30 international journal papers and 50+ conference papers. Senior Member of IEEE and Fellow IE(I). Holds 4 granted patents. Has chaired IEEE conferences in the USA, Italy, and Singapore." },
  { name: "Dr. Arghya Mitra",         role: "Assistant Professor (Gr-I), Electrical Engineering", inst: "VNIT Nagpur",                           topic: "Energy Management for Sustainable Microgrid",                 badge: "Invited",        image: imgArghyaMitra,       bio: "Dr. Mitra received his Ph.D. from IIT Kharagpur (2015) and won the POSOCO Power System Award 2016. He has 80+ research publications including IEEE Transactions and holds a national patent. PI of an MoE-SPARC project and Co-PI in EU-India Horizon 2020 RE-EMPOWERED (Rs. 9.15 Cr) and MeitY-MHI wireless EV charger project (Rs. 5.28 Cr)." },
  { name: "Dr. Lalitesh Kumar",       role: "Research Assistant, PI Lab",                 inst: "SUSTECH, Shenzhen, China",                    topic: "PEM Fuel Cell Stability via Port-Hamiltonian Control",        badge: "International",  image: imgLaliteshKumar,     bio: "Dr. Kumar's research focuses on Fuel Cell/Sustainable Energy, Optimal and Nonlinear Control, port-Hamiltonian Systems, and Fractional Order Control. His work bridges advanced mathematical control theory with clean energy applications for next-generation hydrogen fuel cell systems." },
  { name: "Dr. Subhojit Ghosh",       role: "Professor, Electrical Engineering",           inst: "NIT Raipur",                                  topic: "Cyber Resiliency of Legacy Power Networks",                   badge: "Invited",        image: imgSubhojitGhosh,     bio: "Dr. Ghosh's research spans Optimization, System Modeling and Control, Renewable Energy, and Cyber Physical Systems. His work on cyber resiliency addresses the challenge of securing legacy power infrastructure against cyber threats under resource-constrained operational settings — a growing concern in modern smart grid deployments." },
  { name: "Pratyush Anand",           role: "Software Engineer",                          inst: "Microsoft",                                   topic: "Writing Software/Firmware for Energy Efficient Systems",      badge: "Industry",       image: imgPratyushAnand,     bio: "Pratyush Anand is an engineer at Microsoft with deep expertise in embedded systems, operating systems, and firmware development. He brings an industry perspective on how firmware design choices directly impact energy efficiency in modern computing and industrial systems." },
  { name: "Dr. Giambattista Gruosso", role: "Associate Professor",                        inst: "Politecnico di Milano, Italy",                topic: "Shaping the Future of EV Charging: Power, Communication & ICT Integration", badge: "International", image: imgGruosso, bio: "Dr. Gruosso is an international expert in EV charging infrastructure, focusing on holistic integration of power systems, communication networks, and ICT for next-generation EV ecosystems. His work addresses the complex interdependencies between charging stations and urban power and communication grids." },
  { name: "Dr. Lesedi Masisi",        role: "Senior Lecturer, School of EIE",             inst: "Univ. of Witwatersrand, Johannesburg",        topic: "Electrical Machines and Drives for Sustainable Development", badge: "International",  image: imgLesediMasisi,      bio: "Dr. Masisi received his Ph.D. from Concordia University. His research focuses on electrical energy conversion, rotating machines, and renewable energy systems development — bringing a global perspective on sustainable electrical engineering and drives for modern power applications." },
  { name: "Dr. Ajay Kumar",           role: "Assistant Professor, Electrical Engineering", inst: "Punjab Engineering College, Chandigarh",      topic: "Control Strategies for Grid-Connected Solar PV Systems",      badge: "Invited",        image: imgAjayKumar,         bio: "Dr. Ajay Kumar (MIEEE, MIE) specialises in distributed generation, renewable energy integration, and power quality assessment. His research emphasises control structure development, hardware testing, and experimental result analysis for grid-connected solar PV systems." },
  { name: "Dr. M. Jaya Bharata Reddy",role: "Professor, Electrical & Electronics Engineering", inst: "NIT Tiruchirappalli",                   topic: "PMU Application to Smart Grid",                               badge: "Invited",        image: imgJayaReddy,         bio: "Dr. Reddy received his Ph.D. from BIT Ranchi (2008), won the IEI Young Engineer's Award (2010) and DST SERC Fast Track Young Scientist Award (2013). Senior Member of IEEE. Holds 3 patents and 110+ publications. Has received 4 DST-funded projects worth ~Rs. 177 Lakhs. Research: smart grid, substation automation, and wide-area protection." },
  { name: "Prof. K.B. Mohanty",       role: "Professor, Electrical Engineering",           inst: "NIT Rourkela",                                topic: "Advanced Control for High-Performance Wind Electrical Systems", badge: "Invited",       image: imgKBMohanty,         bio: "Prof. Mohanty received his Ph.D. from IIT Kharagpur. He is a recipient of the Global Research Excellence Award, IEI Excellence Awards, and IETE J.C. Bose Memorial Award. Fellow of IE(I) and IETE, Senior Member IEEE. He has guided 15 Ph.D. students and published 70+ journals and 130+ conference papers." },
  { name: "Prof. Bidyadhar Subudhi",  role: "Professor, School of Electrical Sciences",   inst: "IIT Goa (Former Director, NIT Warangal)",    topic: "Robust & Adaptive Control for PV and Microgrid Systems",      badge: "Keynote",        image: imgBidyadharSubudhi,  bio: "Prof. Subudhi is Dean (R&D) at IIT Goa. His specializations include System & Control Theory, Robust and Adaptive Control, Control of PV systems and Microgrids, Active Power Filtering, Wide Area Control, Blockchain Technology, Microgrid planning, and AI techniques in Power Systems." },
  { name: "Dr. Soumya Chatterjee",    role: "Associate Professor, Electrical Engineering", inst: "NIT Durgapur",                                topic: "Condition Monitoring of HV Systems with Renewable Energy Integration", badge: "Invited", image: imgSoumyaChatterjee,  bio: "Dr. Chatterjee holds a B.E. from Jadavpur University (2009), M.Sc. in Electrical Power Engineering from TU Darmstadt, Germany (2014), and Ph.D. from Jadavpur University (2019). His research focuses on condition monitoring and diagnostic techniques for high voltage electrical systems." },
  { name: "Dr. Aditya R. Gautam",     role: "Assistant Professor, EEE",                   inst: "BITS Pilani",                                 topic: "Control Techniques for Renewable Energy Applications",        badge: "Invited",        image: imgAdityaGautam,      bio: "Dr. Gautam received his Ph.D. from IIT Jodhpur (2019). He joined BITS Pilani in July 2019. Research interests: control of power electronic converters, microgrids, electric vehicles, and renewable energy technology — bridging theoretical control design with practical implementation." },
  { name: "Dr. Deepak Kumar",         role: "Assistant Professor, EEE",                   inst: "BIT Mesra, Ranchi",                           topic: "Smart Controllers for PV Inverter & Demand Side Management", badge: "Faculty",        image: imgDeepakKumar,       bio: "Dr. Deepak Kumar's research spans Blockchain technology for energy systems, microgrid planning, demand side management, design of smart controllers for PV inverter operation, hybrid energy storage systems with EV integration, and AI techniques in power systems." },
  { name: "Dr. S.K. Mishra",          role: "Head, Department of EEE",                    inst: "BIT Mesra, Ranchi",                           topic: "AI in Autonomous Vehicles & Smart Agriculture",               badge: "Faculty",        image: imgSKMishra,          bio: "Dr. Mishra specialises in Signal, Image and Video Processing, Control Systems, Bio-Medical Image Processing, Soft and Evolutionary Computing, AI-based Visual Control of Autonomous Ground Vehicles, AI in Smart Agriculture, and AI in Healthcare." },
];

const committee = [
  { role: "Patron",      name: "Prof. Indranil Manna",        title: "Vice Chancellor\nBIT Mesra, Ranchi",        initials: "IM",  contact: null },
  { role: "Chairman",    name: "Dr. Sudhansu Kumar Mishra",   title: "Head, EEE Department\nBIT Mesra, Ranchi",   initials: "SKM", contact: null },
  { role: "Coordinator", name: "Dr. Debomita Ghosh",          title: "EEE Dept., BIT Mesra, Ranchi",              initials: "DG",  contact: { phone: "+91-7001132557", email: "debomita.ghosh@bitmesra.ac.in" } },
  { role: "Coordinator", name: "Dr. Sourabh Paitandi",        title: "EEE Dept., BIT Mesra, Ranchi",              initials: "SP",  contact: { email: "sourabh_paitandi@bitmesra.ac.in" } },
>>>>>>> 07a83ef3003253ed5fba91634576245fceadf0a4
];
...
=======
    { l: "Dates",  v: "18–22 May 2026" },
    { l: "Format", v: "Five Day Workshop · Hands-on Training" },
    { l: "Theme",  v: "Emerging Control & Digital Technologies for Sustainable Green Energy" },
    { l: "Venue",  v: "Dept. of EEE, BIT Mesra, Ranchi" },
    { l: "Mode",   v: "Offline · Physical" },
    { l: "Seats",  v: "₹150 Registration Fee · 200 Seats · First Come First Serve" },
>>>>>>> 07a83ef3003253ed5fba91634576245fceadf0a4
  ];
...
=======
              { IcoC: IcoCalendar, lbl: "Dates",    val: "18 – 22 May 2026" },
              { IcoC: IcoPin,      lbl: "Venue",    val: "Dept. of EEE, BIT Mesra\nRanchi, Jharkhand – 835215" },
              { IcoC: IcoClock,    lbl: "Duration", val: "5 Days · Hands-on Training" },
              { IcoC: IcoUser,     lbl: "Eligible", val: "Faculty · PhD · PG · Industry" },
              { IcoC: IcoAward,    lbl: "Cert.",    val: "80% Attendance + 70% Assessment" },
              { IcoC: IcoMail,     lbl: "Contact",  val: "debomita.ghosh@bitmesra.ac.in" },
            ].map(r => (
>>>>>>> 07a83ef3003253ed5fba91634576245fceadf0a4
              <div className="hc-row" key={r.lbl}>
                <div className="hc-ico"><r.IcoC size={16} color="#7edfa8" /></div>
                <div>
...
=======
                <p>This <strong>five-day offline Faculty Development Programme</strong> brings together 18 distinguished speakers from IITs, NITs, international universities, and industry to deliver a rigorous exploration of emerging control and digital technologies for green energy systems.</p>
                <p>The programme covers the full spectrum — from <strong>EV charging infrastructure and bidirectional grid interactions</strong> to AI-driven predictive maintenance, port-Hamiltonian control, and cyber-resilience of legacy power networks.</p>
                <p>Designed for <strong>faculty, PhD scholars, and industry professionals</strong>. Certificates awarded on meeting attendance and assessment criteria. All participants receive welcome kits and high tea at inauguration and valedictory.</p>
>>>>>>> 07a83ef3003253ed5fba91634576245fceadf0a4
              </div>
            </div>
...
=======
                { num: "18",  gold: false, lbl: "Distinguished Speakers from IITs, NITs, International Universities", w: "95%" },
                { num: "5",   gold: false, lbl: "Days of Intensive Hands-on Training",                                w: "100%" },
                { num: "200", gold: false, lbl: "Maximum Participant Capacity",                                       w: "60%" },
                { num: "150", gold: true,  lbl: "Registration Fee (₹)",                                              w: "5%" },
                { num: "3",   gold: true,  lbl: "International Speakers",                                             w: "50%" },
              ].map(s => (
>>>>>>> 07a83ef3003253ed5fba91634576245fceadf0a4
...
=======
              { IcoC: IcoPlug,  h: "EV & Power Electronics",  d: "Bidirectional EV chargers, V2G technology, Z-source inverters, and digital controllers for power converters." },
              { IcoC: IcoGlobe, h: "Smart Grid & Microgrids",  d: "PMU applications, microgrid energy management, cyber resiliency of legacy networks, and wide-area control." },
              { IcoC: IcoBrain, h: "AI & Control Systems",     d: "AI-based predictive maintenance, robust adaptive control for PV, port-Hamiltonian frameworks, and wind control." },
              { IcoC: IcoSun,   h: "Renewable Energy Systems", d: "Solar PV grid integration, HV condition monitoring, sustainable energy applications, and RE control techniques." },
>>>>>>> 07a83ef3003253ed5fba91634576245fceadf0a4
            ].map((o, i) => (
              <div className="obj-card" key={i}>
                <div className="obj-ico"><o.IcoC size={26} color="#14834a" /></div>
                <h4>{o.h}</h4>
                <p>{o.d}</p>
              </div>
            ))}
...
=======
            <p style={{ color: "#64748b", fontSize: ".95rem", lineHeight: 1.75 }}>
              ...
              <strong style={{ color: "#18a352" }}>Click any session row</strong> to view the speaker's full profile and bio.
>>>>>>> 07a83ef3003253ed5fba91634576245fceadf0a4
            </p>
          </div>
...
=======
              { IcoC: IcoCalendar, lbl: "Dates",    val: "18 – 22 May 2026",              sub: "Five consecutive days" },
              { IcoC: IcoPin,      lbl: "Venue",    val: "EEE Dept., BIT Mesra",          sub: "Birla Institute of Technology, Ranchi – 835215" },
              { IcoC: IcoMonitor,  lbl: "Format",   val: "Five Day Workshop",              sub: "Offline · Physical Mode · Hands-on Training" },
              { IcoC: IcoUser,     lbl: "Eligible", val: "Faculty · PhD · PG · Industry", sub: "AICTE-approved institutions & industry professionals" },
              { IcoC: IcoUsers,    lbl: "Capacity", val: "Maximum 200 Seats",             sub: "First come first serve" },
              { IcoC: IcoCurrency, lbl: "Fee",       val: "₹150 Registration Fee",         sub: "Per participant" },
            ].map(e => (
>>>>>>> 07a83ef3003253ed5fba91634576245fceadf0a4
              <div className="ev-card" key={e.lbl}>
                <div className="ev-ico"><e.IcoC size={22} color="#14834a" /></div>
...
=======
            <p style={{ color: "#64748b", fontSize: ".95rem", lineHeight: 1.75 }}>
              Registration fee ₹150. Limited to 200 seats — first come first serve. Last date: <strong>15 May 2026</strong>.
>>>>>>> 07a83ef3003253ed5fba91634576245fceadf0a4
            </p>
          </div>
          <div className="reg-grid">
            <ul className="info-list">
              {[
                { IcoC: IcoMail,      lbl: "Coordinators",       val: "debomita.ghosh@bitmesra.ac.in\nsourabh_paitandi@bitmesra.ac.in" },
                { IcoC: IcoPhone,     lbl: "Phone",              val: "+91-7001132557" },
