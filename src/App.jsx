...
const styles = `
  ...
  *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
  ...
  .nb-links a {
    font-size: .83rem; font-weight: 600; color: var(--navy-soft);
  ...
  .hero-img {
    ...
    background:
      linear-gradient(135deg, rgba(15,23,42,.92) 0%, rgba(15,23,42,.78) 55%, rgba(5,150,105,.25) 100%),
      url('https://images.unsplash.com/photo-1466611653911-95081537e5b7?w=1800&q=80') center/cover no-repeat;
    z-index: 0;
  }
  /* subtle dot-grid */
  .hero-dots {
  ...
  .hero-body {
    ...
    padding: 0 2rem; padding-top: 68px;
  ...
  .muted { color: var(--slate); font-size: 1rem; line-height: 1.75; font-weight: 300; }
  ...
  .about-text p { font-size: 1rem; line-height: 1.82; color: var(--navy-soft); margin-bottom: .9rem; font-weight: 300; }
  ...
  .stats-panel h3 { font-family: 'Playfair Display', serif; font-size: 1.15rem; font-weight: 700; color: #fff; margin-bottom: 1.75rem; }
  .s-item { padding: 1rem 0; border-bottom: 1px solid rgba(255,255,255,.08); display: flex; align-items: center; gap: 1rem; }
  ...
  .s-lbl { font-size: .78rem; color: rgba(255,255,255,.52); text-transform: uppercase; letter-spacing: .08em; line-height: 1.4; }
  .s-bar { flex: 1; height: 3px; background: rgba(255,255,255,.06); border-radius: 2px; overflow: hidden; }
  ...
  .obj-card h4 { font-family: 'Playfair Display', serif; font-size: 1rem; font-weight: 700; color: var(--navy); margin-bottom: .5rem; }
  .obj-card p  { font-size: .88rem; color: var(--slate); line-height: 1.65; margin: 0; }

  /* ─── TOPICS ─── */
  .topics-wrap { background: var(--navy); }
  ...
  .topic-item span { font-size: .9rem; color: rgba(255,255,255,.75); line-height: 1.55; }
  ...
  .topics-aside p { font-size: .82rem; color: rgba(255,255,255,.42); line-height: 1.65; margin: 0; }
  ...
  .sp-card:hover { transform: translateY(-5px); box-shadow: 0 20px 40px rgba(15,23,42,.1); border-color: var(--emerald-lt); }
  .sp-avatar {
    aspect-ratio: 1; background: linear-gradient(135deg, var(--navy) 0%, var(--navy-mid) 100%);
    display: flex; align-items: center; justify-content: center;
  ...
  .sp-name  { font-family: 'Playfair Display', serif; font-size: 1rem; font-weight: 700; color: var(--navy); margin-bottom: .2rem; }
  .sp-role  { font-size: .8rem; color: var(--emerald-dk); font-weight: 600; margin-bottom: .15rem; }
  .sp-inst  { font-size: .78rem; color: var(--slate); }
  .sp-badge { display: inline-block; margin-top: .75rem; font-size: .68rem; font-weight: 700; text-transform: uppercase; letter-spacing: .1em; padding: .28rem .65rem; border-radius: 50px; background: var(--emerald-xs); color: var(--emerald-dk); border: 1px solid var(--emerald-lt); }

  /* ─── EVENT DETAILS ─── */
  .ev-wrap { background: var(--bg); }
  ...
  .ev-label { font-size: .68rem; font-weight: 700; text-transform: uppercase; letter-spacing: .14em; color: var(--slate); margin-bottom: .35rem; }
  .ev-val   { font-family: 'Playfair Display', serif; font-size: 1.1rem; font-weight: 700; color: var(--navy); line-height: 1.3; }
  .ev-sub   { font-size: .8rem; color: var(--slate); margin-top: .25rem; }
  ...
  .cert-lbl { font-size: .7rem; font-weight: 700; text-transform: uppercase; letter-spacing: .12em; color: var(--emerald-dk); margin-bottom: .2rem; }
  .cert-txt { font-size: .88rem; color: var(--slate); line-height: 1.6; margin: 0; }

  /* ─── REGISTER ─── */
  .reg-wrap { background: var(--white); }
  ...
  .success-box h3 { font-family: 'Playfair Display', serif; font-size: 1.45rem; color: var(--navy); margin-bottom: .6rem; }
  .success-box p { color: var(--slate); font-size: .95rem; line-height: 1.7; }
  .success-box strong { color: var(--emerald-dk); }
  ...
  .info-lbl { font-size: .68rem; font-weight: 700; text-transform: uppercase; letter-spacing: .12em; color: var(--emerald-dk); margin-bottom: .15rem; }
  .info-val { font-size: .88rem; color: var(--navy-soft); line-height: 1.5; }

  /* ─── FOOTER ─── */
  footer { background: var(--navy); padding: 4rem 2rem 1.75rem; }
  ...
  .ft-sub { font-size: .75rem; color: rgba(255,255,255,.3); text-transform: uppercase; letter-spacing: .12em; margin-bottom: .9rem; }
  .ft-about { font-size: .85rem; color: rgba(255,255,255,.38); line-height: 1.7; max-width: 360px; }
  ...
  .ft-list li { font-size: .85rem; color: rgba(255,255,255,.42); margin-bottom: .4rem; line-height: 1.55; }
  .ft-list li strong { color: rgba(255,255,255,.65); font-weight: 500; }
  ...
  .ft-bottom p { font-size: .77rem; color: rgba(255,255,255,.25); }
...
export default function SeminarPage() {
  ...
  return (
    <>
      ...
      {/* ── OBJECTIVES ── */}
      <div style={{padding:"96px 2rem",background:"var(--bg)"}}>
      ...
      {/* ── SPEAKERS ── */}
      <div id="speakers" style={{padding:"96px 2rem",background:"var(--white)"}}>
        <div style={{maxWidth:1280,margin:"0 auto"}}>
          ...
          <div className="speakers-grid">
            {speakers.map((s,i) => (
              <div className="sp-card" key={i}>
                <div className="sp-avatar">{s.init}</div>
